...
exports.sourcePreview = exports.sourcePreviews = exports.inPreviewMode = void 0;
...
const inPreviewMode = () => !!process.env.ENABLE_GATSBY_REFRESH_ENDPOINT && !!_store.default.getState().previewStore.inPreviewMode;
...
const sourcePreviews = async ({
  ...
  if (!(previewActions === null || previewActions === void 0 ? void 0 : previewActions.length)) {
    if (inPreviewDebugMode) {
  ...
  previewActions === null || previewActions === void 0 ? void 0 : previewActions.forEach(({
    previewData
  }) => {
...
const sourcePreview = async ({
  ...
  _store.default.dispatch.previewStore.setInPreviewMode(true); // this callback will be invoked when the page is created/updated for this node
...
const createPreviewStatusCallback = ({
  ...
  const statusContext = (error === null || error === void 0 ? void 0 : error.message) ? `${context}\n\n${error.message}` : context;
  const {
    data
  ...
  if (data === null || data === void 0 ? void 0 : (_data$wpGatsbyRemoteP = data.wpGatsbyRemotePreviewStatus) === null || _data$wpGatsbyRemoteP === void 0 ? void 0 : _data$wpGatsbyRemoteP.success) {
...
const writeDummyPageDataJsonIfNeeded = async ({
  ...
  const pageDataExists = await _fsExtra.default.exists(pageDataPath);
...
const previewForIdIsAlreadyBeingProcessed = id => {
  ...
  const alreadyProcessingThisPreview = !!(existingCallbacks === null || existingCallbacks === void 0 ? void 0 : existingCallbacks[id]);
