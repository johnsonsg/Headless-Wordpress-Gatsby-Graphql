...
var _deprecationNotice = _interopRequireDefault(require("../../deprecation-notice.json"));
...
const ensurePluginRequirementsAreMet = async helpers => {
  ...
  helpers.reporter.log((0, _formatLogMessage.formatLogMessage)(`

${_chalk.default.bold(`Upgrade/deprecation notice:`)}

${_deprecationNotice.default}`));
