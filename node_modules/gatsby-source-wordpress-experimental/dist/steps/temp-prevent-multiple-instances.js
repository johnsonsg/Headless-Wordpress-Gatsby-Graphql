...
function tempPreventMultipleInstances({
  ...
  if (isWpSourcePluginInstalled) {
    reporter.panic((0, _formatLogMessage.formatLogMessage)([`Multiple instances of this plugin aren't currently supported yet.`, `Follow this issue for updates https://github.com/gatsbyjs/gatsby-source-wordpress-experimental/issues/58`].join(`\n\n`), {
