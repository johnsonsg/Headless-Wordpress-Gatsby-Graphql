...
exports.onCreatePageRespondToPreviewStatusQuery = exports.onCreatepageSavePreviewNodeIdToPageDependency = void 0;
...
const onCreatepageSavePreviewNodeIdToPageDependency = helpers => {
  ...
  if (nodeThatCreatedThisPage) {
    _store.default.dispatch.previewStore.saveNodePageState({
...
const onCreatePageRespondToPreviewStatusQuery = async (helpers) => {
  ...
  } = _store.default.getState().previewStore;
  ...
  _store.default.dispatch.previewStore.unSubscribeToPagesCreatedFromNodeById({
